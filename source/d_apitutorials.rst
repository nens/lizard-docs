...
| `Virtual Environment Requirements </_files/_tutorials/requirements.txt>`_


1. Interactive Time Series API manual 
-------------------------------------

| `Notebook for /api/v4/timeseries </_files/_tutorials/Lizard_Time_Series_API_V4_Tutorial.ipynb>`_
...
| `Notebook for 3Di results / Scenarios in Lizard </_files/tutorials/How_to_download_a_maximum_waterdepth_raster_from_a_3Di_scenario_stored_in_the_Scenario_Archive_in_Lizard_.ipynb>`_
